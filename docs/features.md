# Forge IDE - Cool Productive Features
...
- **Global Search**: Search across blocks, tasks, code, and documentation
...
- **ML Model Training**: Train and deploy ML models from the IDE
