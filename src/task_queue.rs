...
impl TaskQueue {
    ...
    pub fn enqueue_task(&self, block_id: &str, task_id: &str, task_description: &str) -> Result<String, String> {
...
pub fn enqueue_task(block_id: &str, task_id: &str, task_description: &str) -> Result<String, String> {
