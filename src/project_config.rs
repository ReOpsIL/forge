...
pub const DEFAULT_REFACTOR_USER_PROMPT: &str =
...
impl Default for ProjectConfig {
    fn default() -> Self {
        Self {
            ...
            enhance_description_system_prompt: Some(
                DEFAULT_ENHANCE_DESCRIPTION_SYSTEM_PROMPT.to_string(),
            ),
            enhance_description_user_prompt: Some(
                DEFAULT_ENHANCE_DESCRIPTION_USER_PROMPT.to_string(),
            ),
            ...
            generate_tasks_system_prompt_mcp: Some(
                DEFAULT_GENERATE_TASKS_SYSTEM_PROMPT_MCP.to_string(),
            ),
            generate_tasks_user_prompt_mcp: Some(
                DEFAULT_GENERATE_TASKS_USER_PROMPT_MCP.to_string(),
            ),
            process_specification_system_prompt: Some(
                DEFAULT_PROCESS_MARKDOWN_SPEC_SYSTEM_PROMPT.to_string(),
            ),
            process_specification_user_prompt: Some(
                DEFAULT_PROCESS_MARKDOWN_SPEC_USER_PROMPT.to_string(),
            ),
            process_specification_system_prompt_mcp: Some(
                DEFAULT_PROCESS_MARKDOWN_SPEC_SYSTEM_PROMPT_MCP.to_string(),
            ),
            process_specification_user_prompt_mcp: Some(
                DEFAULT_PROCESS_MARKDOWN_SPEC_USER_PROMPT_MCP.to_string(),
            ),
        }
    }
}
...
lazy_static! {
    static ref PROJECT_MANAGER: Arc<ProjectConfigManager> =
        Arc::new(ProjectConfigManager::new(PROJECT_CONFIG_FILE));
}
