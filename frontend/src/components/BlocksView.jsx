                    ...
                    <div className="w-full">
                      ...
                      <div className="flex justify-content-end mt-2">
                        ...
                        <Button 
                          ...
                          onClick={() => setEditingBlockName({...editingBlockName, [block.name]: undefined})}
                          tooltip="Cancel"
                        />
                      </div>
                    </div>
                  ...
                  {block.todo_list.length > 0 ? (
                    <ul className="m-0 p-0 list-none">
                      {block.todo_list.map((todo, index) => (
                        <li key={index} className="mb-2 flex align-items-center justify-content-between task-item">
                          <div className="flex align-items-center">
                            <Checkbox 
