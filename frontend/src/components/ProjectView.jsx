        ...
        <div className="p-fluid">
          <div className="field">
            ...
            <InputText 
              ...
              className="w-full"
            />
            <small className="text-muted">The URL of the Git repository associated with this project.</small>
          </div>
          ...
          <div className="field">
            ...
            <InputText 
              ...
              className="w-full"
            />
            <small className="text-muted">The root directory for the project on the local file system.</small>
          </div>
          ...
          <div className="field">
            ...
            <small className="text-muted">A descriptive summary of the project. Markdown is supported.</small>
          </div>
        </div>
      </Card>
    </div>
